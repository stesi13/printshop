...
- `lib/etsy/` — Etsy listing-CSV exporter and manual order-ingest module. See [`docs/etsy-integration.md`](docs/etsy-integration.md).
- `scripts/admin.ts` — internal CLI for catalog + marketplace ops (`npm run admin -- product:list`, `etsy:export-listings`, `etsy:ingest-order`, `order:list`).
